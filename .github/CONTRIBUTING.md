...
1. [Fork](https://github.com/$(REPO_ORG)/$(REPO_NAME)/fork) and clone the repository
...
8. Push to your fork and [submit a pull request](https://github.com/$(REPO_ORG)/$(REPO_NAME)/compare)
